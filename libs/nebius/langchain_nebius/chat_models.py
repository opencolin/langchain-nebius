...
class ChatNebius(BaseChatOpenAI):
    r"""ChatNebius chat model.
    ...
    def lc_attributes(self) -> Dict[str, Any]:
        ...
        if self.nebius_api_base:
            attributes["nebius_api_base"] = self.nebius_api_base
    ...
    def validate_environment(self) -> Self:
        ...
        client_params: dict = {
            "api_key": (
                self.nebius_api_key.get_secret_value()
